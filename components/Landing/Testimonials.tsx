            ...
            <div className="relative container mx-auto">
                <div className="mx-auto mb-12 max-w-2xl text-center">
                    ...
                    <h2 className="mb-4 text-2xl font-bold text-[#222222] md:text-3xl lg:text-4xl">
                        What Our <span className="text-[#FA7436]">Guests</span>{" "}
                        Say
                    </h2>
                    <p className="text-xs text-[#666666]">
                        Real experiences from travelers who have explored
                        Palestine with AeroCanaan
                    </p>
                </div>
                <div className="relative py-10">
                    ...
                    >
                        {testimonials.map((testimonial, index) => (
                            ...
                            >
                                <Card className="border-primary shadow-primary flex w-full flex-col items-center rounded-2xl bg-white p-6 text-center shadow-sm transition-all duration-300 hover:scale-105">
