...
const Banner = () => {
    ...
    return (
        <div className="from-accent to-background relative overflow-hidden bg-gradient-to-b py-12 md:py-7">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center space-y-6">
                        ...
                        <h1 className="text-foreground text-xl leading-tight font-bold md:text-4xl lg:text-6xl">
                            Discover The{" "}
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Button
                                variant="outline"
                                className="text-foreground hover:bg-accent border-[#FA7436] px-6"
                                asChild
                            >
                        ...
                        <div className="mt-2 flex items-center gap-4">
                            <div className="flex -space-x-3">
                                {[1, 2, 3].map((avatar) => (
                                    <Avatar
                                        key={avatar}
                                        className="border-background h-12 w-12 overflow-hidden rounded-full border-2"
                                    >
                                        ...
                                        <div className="relative p-1">
                                            <Card className="overflow-hidden border-none py-0 shadow-lg">
                                                <CardContent className="relative flex aspect-[4/3] items-center justify-center p-0">
                                                    ...
                                                    />
                                                    <div className="text-primary-foreground absolute right-0 bottom-0 left-0 bg-gradient-to-t from-black/70 to-transparent p-6">
