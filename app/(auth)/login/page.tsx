            ...
            <div className="w-full max-w-md overflow-hidden rounded-2xl shadow-2xl">
                ...
                <div className="relative space-y-5 bg-black/40 p-7 text-sm backdrop-blur-md transition-all duration-300 ease-in-out">
                    ...
                    <div className="relative">
                        <h1 className="mb-1.5 text-center text-2xl font-bold text-white">
                            Welcome Back
                        </h1>
                        ...
                        <div className="space-y-2">
                            <div className="group relative">
                                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    <User
                                        className="text-orange-300 group-focus-within:text-orange-500"
                                        size={18}
                                    />
                                </div>
                                <input
                                    ...
                                    className="w-full rounded-md border border-white/10 bg-white/5 px-4 py-2.5 pl-10 text-sm text-white placeholder-white/50 shadow-sm focus:border-orange-500 focus:bg-black/20 focus:ring-1 focus:ring-orange-500 focus:outline-none"
                                    required
                                />
                            </div>
                        </div>
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <Link
                                    ...
                                    className="text-xs text-orange-300 hover:text-orange-400"
                                >
                                    Forgot password?
                                </Link>
                            </div>
