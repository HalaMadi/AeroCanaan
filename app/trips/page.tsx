  ...
  return (
    <div className="min-h-screen bg-white p-8 flex flex-col justify-center items-center">
      ...
      <div className="mt-6 flex justify-center space-x-4">
        <button 
          className={`px-4 py-2 rounded-lg ${currentPage === 1 ? "bg-gray-300" : "bg-orange-500 text-white hover:bg-orange-600"}`} 
        ...
        <button 
          className={`px-4 py-2 rounded-lg ${currentPage === totalPages ? "bg-gray-300" : "bg-orange-500 text-white hover:bg-orange-600"}`} 
          onClick={() => setCurrentPage(currentPage + 1)} 
      ...
      {selectedTrip && <Book trip={selectedTrip} onClose={() => setSelectedTrip(null)} />}
    </div>
  );
}
