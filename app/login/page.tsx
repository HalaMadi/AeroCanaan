    ...
    >
      <div className="w-full max-w-md overflow-hidden rounded-2xl shadow-2xl">
        ...
        <form
          ...
          className="relative bg-black/40 backdrop-blur-md p-8 space-y-6 transition-all duration-300 ease-in-out"
        >
          {/* Decorative elements */}
          ...
          <div className="relative">
            ...
            <p className="text-center text-orange-200 text-sm mb-8">Log in to your account to continue</p>
          </div>
