            ...
            <form onSubmit={handleSave} className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label htmlFor="firstName" className="text-gray-700 text-xs font-medium uppercase tracking-wide">
                    First Name
                  </label>
                  <div className="group relative">
                    <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                      <User
                        className="text-gray-400 group-focus-within:text-[#E17100] transition-colors duration-200"
                        size={18}
                      />
                    </div>
                    <input
                      ...
                      className="w-full rounded-md border border-gray-200 bg-gray-50 px-4 py-2.5 pl-10 text-sm text-gray-800 placeholder-gray-400 shadow-sm transition-all duration-200 focus:border-[#E17100] focus:bg-white focus:ring-1 focus:ring-[#E17100] focus:outline-none"
                    />
                  </div>
                </div>
                <div className="space-y-2">
