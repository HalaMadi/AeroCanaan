...
export const destinations = [
    {
      ...
      localTips: "Visit early in the morning to avoid crowds, especially at major religious sites.",
      availableTrips: 5,
      trips: [
        {
          name: "Jerusalem Heritage Tour",
          description: "A comprehensive day tour exploring the four quarters of the Old City with an expert guide.",
        ...
        },
        {
          ...
          description: "Focus on the religious significance of Jerusalem's holy sites across three faiths.",
          duration: "6 hours",
          price: 75,
    ...
    },
    {
      ...
      bestTimeToVisit: "Year-round, though Christmas season (December) offers special celebrations",
      accessibilityInfo:
      ...
      trips: [
        {
          ...
          description: "Visit the Church of the Nativity and other significant religious sites in Bethlehem.",
      ...
      trips: [
        {
          ...
          description: "Enjoy a full day at the Dead Sea with time for floating, mud treatments, and relaxation.",
          duration: "Full day (8 hours)",
          price: 75,
          nextAvailable: "Daily",
          maxParticipants: 20,
        },
        {
          ...
          description: "Combine a visit to the historic fortress of Masada with relaxation time at the Dead Sea.",
    ...
    },
    {
      ...
      localTips: "Hebron is known for its glass and ceramic production - visit workshops to see artisans at work",
      availableTrips: 2,
      trips: [
        {
    ...
    },
    {
      ...
      bestTimeToVisit: "Spring (March-May) when wildflowers bloom and temperatures are moderate",
      accessibilityInfo:
      ...
      trips: [
        {
          ...
          description: "A guided hike through the dramatic landscapes of Wadi Qelt with a visit to St. George Monastery.",
          duration: "Full day (8 hours)",
          price: 85,
        ...
        },
        {
          ...
          description: "Focus on the historical monasteries in the Judean Desert, including St. George in Wadi Qelt.",
          duration: "7 hours",
          price: 75,
      ...
      trips: [
        {
          ...
          description: "Explore the old city, visit traditional soap factories, and enjoy authentic Palestinian cuisine.",
          duration: "Full day (8 hours)",
          price: 70,
    ...
    },
    {
      ...
      localTips: "Combine with a visit to Bethlehem. Dress modestly and bring water as facilities are limited.",
      availableTrips: 1,
      trips: [
        {
          name: "Desert Monasteries Tour",
          description: "Visit Mar Saba and other ancient monasteries in the Judean Desert.",
    ...
    },
    {
      ...
      bestTimeToVisit: "Spring when the terraces are green and wildflowers bloom",
      accessibilityInfo:
        "Some paths through the terraces are uneven and may be challenging for those with mobility issues",
      localTips: "Hike the 'Battir Cultural Landscape Trail' for the best views of the terraces and irrigation system",
      availableTrips: 2,
      trips: [
        {
          name: "Battir Eco-Tour",
          description: "Explore the UNESCO World Heritage terraces and learn about traditional Palestinian agriculture.",
          duration: "Half day (5 hours)",
          price: 60,
    ...
    },
    {
      ...
      accessibilityInfo: "Most major sites are accessible, though some archaeological areas have uneven terrain",
      localTips:
      ...
      trips: [
        {
          ...
          description: "Explore Tel es-Sultan (ancient Jericho), Hisham's Palace, and the Mount of Temptation.",
          duration: "Full day (7 hours)",
          price: 75,
          nextAvailable: "Daily",
          maxParticipants: 15,
        },
        {
          ...
          description: "Visit the historical sites of Jericho in the morning and enjoy the Dead Sea in the afternoon.",
          duration: "Full day (9 hours)",
          price: 95,
          nextAvailable: "Tue, Thu, Sun",
          maxParticipants: 12,
    ...
    },
    {
      ...
      bestTimeToVisit: "Year-round, check the event calendar for special performances",
